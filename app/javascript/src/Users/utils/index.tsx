/* eslint-disable react/jsx-key, @typescript-eslint/naming-convention */
import type { AdminSection, Feature } from 'Users/types'

const FEATURE_NAMES: Partial<Record<Feature, React.ReactNode>> = {
...
export const FEATURE_NAMES_DESCRIPTION_ITEMS: Record<Feature, React.ReactNode[] | undefined> = {
  portal: undefined,
  finance: undefined,
  settings: undefined,
  partners: [
    <>developer <strong>accounts</strong></>,
    <><strong>applications</strong> of <em>selected API products</em></>
  ],
  monitoring: [
    'all API backends',
    <em>selected API products</em>
  ],
  plans: [
  ...
  policy_registry: [
    <>the APIcast <strong>policy chain and its policies</strong></>
  ]
}
