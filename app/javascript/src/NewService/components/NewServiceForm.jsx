...
const NewServiceForm = (props: Props) => {
  const {isServiceDiscoveryAccesible, isServiceDiscoveryUsable, serviceDiscoveryAuthenticateUrl,
  ...
  const formToRender = () => formMode === 'manual' || !isServiceDiscoveryAccesible
