...
const ServiceManualListItems = ({service, errors}: Props) => {
  ...
  return (
    <React.Fragment>
      ...
      <li id="service_name_input" className={`string required ${!!errors.name && 'error'}`}>
        <Label
      ...
      { /* $FlowFixMe boolean coercion in string literals */ }
      <li id="service_system_name_input" className={`string required ${!!errors.system_name && 'error'}`}>
        <Label
      ...
      { /* $FlowFixMe boolean coercion in string literals */ }
      <li id="service_description_input" className={`text optional ${!!errors.description && 'error'}`}>
        <Label
