...
const QuickStartsResourcesWrapper = (props, containerId: string): void =>
  createReactWrapper(<QuickStartsResources {...props} />, containerId);

export { QuickStartsResources, QuickStartsResourcesWrapper };
