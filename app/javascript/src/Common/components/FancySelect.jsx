...
const FancySelect = <T: Record>({
  ...
  const handleOnFilter = (e: SyntheticEvent<HTMLInputElement>) => {
    ...
    return getSelectOptionsForItems(filteredItems)
  }
...
const FancySelectWrapper = <T: Record>(props: Props<T>, containerId: string): void => createReactWrapper(<FancySelect {...props} />, containerId)

export { FancySelect, FancySelectWrapper }
