      ...
      .then(({ success, message }) => {
        if (success) {
          ...
          if (exceptionBeingAdded) {
            // TODO: remove added product from the collection to remove it from the modal
            // const newProducts = products.filter(p => p.id !== exceptionBeingAdded.id)
            // setPageDictionary(paginateCollection(newProducts, PER_PAGE))
