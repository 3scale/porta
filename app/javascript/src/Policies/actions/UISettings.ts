...
export type ShowUIComponentAction = {
  type: string,
...
export type HideUIComponentAction = {
  type: string,
  component: UIComponent
};
...
export type UIComponentTransitionAction = {
  type: 'UI_COMPONENT_TRANSITION',
  hide: UIComponent,
  show: UIComponent
};
export function uiComponentTransition(
  {
    hide,
    show,
  }: {
