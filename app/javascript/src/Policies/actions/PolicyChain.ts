...
export type AddPolicyToChainAction = {
  type: 'ADD_POLICY_TO_CHAIN',
...
export type RemovePolicyFromChainAction = {
...
export type SortPolicyChainAction = {
  type: 'SORT_POLICY_CHAIN',
...
export type UpdatePolicyInChainAction = {
...
export type UpdatePolicyChainAction = {
  type: 'UPDATE_POLICY_CHAIN',
  payload: Array<ChainPolicy>
};
...
export type LoadChainSuccessAction = {
  type: 'LOAD_CHAIN_SUCCESS',
  payload: Array<ChainPolicy>
};
...
export type LoadChainErrorAction = {
  type: 'LOAD_CHAIN_ERROR',
...
export type FetchChainSuccessAction = {
  type: 'FETCH_CHAIN_SUCCESS',
  payload: Array<ChainPolicy>
};
export type FetchChainErrorAction = {
