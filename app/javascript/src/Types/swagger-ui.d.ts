// based on https://github.com/DefinitelyTyped/DefinitelyTyped/blob/136d21219844ab63d4afc512322fb09c504a931e/types/swagger-ui/index.d.ts

declare module 'swagger-ui' {
  // eslint-disable-next-line @typescript-eslint/naming-convention
  function SwaggerUI (opts: SwaggerUI.SwaggerUIOptions): SwaggerUI

  export type SupportedHTTPMethods = 'delete' | 'get' | 'head' | 'options' | 'patch' | 'post' | 'put' | 'trace'
  ...
  namespace SwaggerUI {
    interface SwaggerUIOptions {
       ...
       */
      requestInterceptor?: ((a: Request) => Promise<Request> | Request) | undefined;
       ...
       */
      responseInterceptor?: ((a: Response) => Promise<Response> | Response) | undefined;
       ...
       */
      parameterMacro?: ((operation: Readonly<unknown>, parameter: Readonly<unknown>) => unknown) | undefined;
    ...
    type PluginLoadType = 'chain' | 'legacy'
