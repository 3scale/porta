...
/**
 * This was copied from https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/jquery.colorbox/index.d.ts
 * but colorbox is injected into rails' jquery, which is different from the one we import from
 * node_modules, so we need to reference JQueryStaticV1
 */
...
interface ColorboxStatic {
   ...
   */
  (settings: ColorboxSettings): unknown;
  /**
