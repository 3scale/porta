 ...
 * and it is applied manually to window.$ and window.jQuery. This way when we use $ in a typescript
 * file we will get proper typings.
 *
 * To use 3.5.x in a typescript file then it needs to be imported from node_modules, i.e.:
 *    import $ from 'jquery'
 *    import 'jquery-ui/ui/widgets/droppable'
 *
 * And it will also get the proper typings.
 *
 */
/* eslint-disable */
