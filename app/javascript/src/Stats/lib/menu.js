    ...
    return (
      <div className="StatsMenu">
        ...
        ? 'is-selected' : ''}`}
              ...
              onclick={() => statsState.setState({ dateRange: new PeriodRangeDate(period) })}>
        ...
        <div className="StatsMenu-custom">
          <span>
            ...
            <a className="StatsMenu-Link StatsMenu-customLink StatsMenu-customLink--since"
              onclick={() => sinceDateHook.open()}>{helpers.humanDateFormat(statsState.state.dateRange.since)}</a>
          </span>
          <span>
            {' until '}
            ...
            <a className="StatsMenu-Link StatsMenu-customLink StatsMenu-customLink--until"
              onclick={() => untilDateHook.open()}>{helpers.humanDateFormat(statsState.state.dateRange.until)}</a>
          </span>
          <span>
            {' per '}
            <a
