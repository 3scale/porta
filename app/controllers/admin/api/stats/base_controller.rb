...
class Admin::Api::Stats::BaseController < Admin::Api::BaseController
  ...
  ##
  ##~ @parameter_backend_api_metric_name = {:description => "System name of metric to get data for.", :name => "metric_name", :dataType => "string", :required => true, :paramType => "query", :threescale_name => "backend_api_metric_names" }
  ##
