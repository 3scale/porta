...
class Admin::Api::Stats::ServicesController < Admin::Api::Stats::BaseController
  before_action :set_source

  ##~ sapi = source2swagger.namespace("Analytics API")
  ##
  ##~ e = sapi.apis.add
  ##~ e.path = "/admin/api/stats/services/{service_id}/usage.{format}"
  #
  ##~ op            = e.operations.add
  ##~ op.httpMethod = "GET"
  ...
  ##
  ##~ e = sapi.apis.add
  ##~ e.path = "/admin/api/stats/services/{service_id}/top_applications.{format}"
  #
  ##~ op            = e.operations.add
  ##~ op.httpMethod = "GET"
