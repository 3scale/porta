...
class Master::Api::ProvidersController < Master::Api::BaseController
  ...
  def create
    signup_result = @account_manager.create(**create_params, signup_result_class: ::Signup::ResultWithAccessToken)
  ...
  def create_params
    ...
    { plans: plans, user_params: user_params.merge(signup_type: :created_by_provider), account_params: create_account_params, defaults: defaults }
  end

  def user_params
    params.permit(*@user.defined_fields_names, :password)
  end

  def permitted_account_attrs
    @provider_account.defined_fields_names | UPDATE_PARAMS
  end
