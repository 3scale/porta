...
class DeveloperPortal::PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_update_password
    ...
    put developer_portal.admin_account_password_path(user: { password: 'Supersecret123+!',
      password_confirmation: 'Supersecret123+!' }, password_reset_token: user.lost_password_token)
    assert_match 'password has been changed', flash[:notice]

    put developer_portal.admin_account_password_path(user: { password: 'Supersecret321+!',
      password_confirmation: 'Supersecret321+!' }, password_reset_token: user.lost_password_token)
