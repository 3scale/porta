...
class Stats::Data::BackendApisControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'usage_response_code with no data as json' do
    get usage_admin_api_stats_backend_apis_path(backend_api_id: backend_api.id, format: :json, access_token: access_token.value), stats_params
  ...
  test 'inexistent source' do
    get usage_admin_api_stats_backend_apis_path(backend_api_id: 0, format: :json, access_token: access_token.value), stats_params
  ...
  test 'user permissions' do
    ...
    get usage_admin_api_stats_backend_apis_path(backend_api_id: backend_api.id, format: :json, access_token: member_access_token.value), stats_params
