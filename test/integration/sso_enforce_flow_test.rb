...
class SsoEnforceFlowTest < ActionDispatch::IntegrationTest
  ...
  def setup
    ...
    @user = FactoryBot.create(:simple_admin, account: @provider, password: 'Supersecret123+!')
    @user.activate!
  ...
  def test_sso_enforce # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
    ...
    post provider_sessions_path(username: @user.username, password: 'Supersecret123+!')
