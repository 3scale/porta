...
class ProviderProxyDeploymentV1ServiceTest < ActiveSupport::TestCase
  ...
  def setup
    ...
    @service = ProviderProxyDeploymentV1Service.new(@provider)
  ...
  test 'conf_content having services integrated via plugin' do
    ...
    deployment_service = ProviderProxyDeploymentV1Service.new(@provider)
  ...
  class WithRollingUpdate < ProviderProxyDeploymentV1ServiceTest
