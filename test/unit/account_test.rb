...
class AccountTest < ActiveSupport::TestCase
  ...
  class AutomatedSuspensionFeatureTest < ActiveSupport::TestCase
    def setup
      account_inactivity = 50
      contract_unpaid_time = 70
      config = {'account_suspension' => 30, 'account_inactivity' => account_inactivity, 'contract_unpaid_time' => contract_unpaid_time, disabled_for_app_plans: ['enterprise']}
    ...
    test 'it finds the right accounts' do
      result_ids = Account.should_be_automatically_suspended.pluck(:id)
  ...
  class AutomatedScheduleForDeletionFeatureTest < ActiveSupport::TestCase
    def setup
      account_suspension = 30
      contract_unpaid_time = 70
      config = {'account_suspension' => account_suspension, 'account_inactivity' => 50, 'contract_unpaid_time' => contract_unpaid_time, disabled_for_app_plans: ['enterprise']}
      Features::AccountDeletionConfig.configure(config)
    ...
    test 'it finds the right accounts' do
      result_ids = Account.should_be_automatically_scheduled_for_deletion.pluck(:id)
