...
class ThreeScale::OAuth2::RedhatCustomerPortalClientTest < ActiveSupport::TestCase
  ...
  class RedirectUriTest < ActiveSupport::TestCase
    ...
    def test_call_always_redirect_to_master_admin_domain
      ...
      assert_equal "http://#{master_account.external_admin_domain}/auth/#{authentication_provider.system_name}/callback?plan_id=1&self_domain=example.net", RedirectUri.call(oauth2, request)
    end
  end
