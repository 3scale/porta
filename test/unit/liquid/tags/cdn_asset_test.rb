...
class Liquid::Tags::CdnAssetTest < ActiveSupport::TestCase
  test 'gets the correct file name' do
    ...
    {
      '/swagger-ui/2.2.10/swagger-ui.js' => '/dev-portal/swagger-ui/2.2.10/swagger-ui.js',
      '/swagger-ui/2.2.10/swagger-ui.min.js' => '/dev-portal/swagger-ui/2.2.10/swagger-ui.min.js',
