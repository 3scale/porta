module TestHelpers
  module Account
    ...
    def stub_provider_account(attributes = {})
      FactoryBot.stub(:provider_account, attributes)
    end

    # TODO: should be factory
    def stub_feature(service, attributes = {})
      attributes[:service] = service
      feature = FactoryBot.stub(:feature, attributes)
    ...
    def stub_bought_cinstance(account, plan)
      cinstance = FactoryBot.stub(:cinstance, :user_account => account, :plan => plan)
    ...
    def stub_invoice(cinstance, options = {})
      ...
      invoice = FactoryBot.stub(:invoice, options.merge(:provider_account => cinstance.provider_account,
    ...
    def stub_usage_limit(plan, attributes = {})
      ...
      usage_limit = FactoryBot.stub(:usage_limit, attributes)
    ...
    def stub_buyer_account(plan, attributes = {})
      buyer_account = FactoryBot.stub(:buyer_account, attributes)

      cinstance = FactoryBot.stub(:cinstance, :plan => plan, :user_account => buyer_account)
