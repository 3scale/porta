module TestHelpers
  module Account
    ...
    def stub_feature(service, attributes = {})
      ...
      feature = FactoryBot.build_stubbed(:feature, attributes)
    ...
    def stub_bought_cinstance(account, plan)
      cinstance = FactoryBot.build_stubbed(:cinstance, :user_account => account, :plan => plan)
    ...
    def stub_invoice(cinstance, options = {})
      ...
      invoice = FactoryBot.build_stubbed(:invoice, options.merge(:provider_account => cinstance.provider_account,
    ...
    def stub_usage_limit(plan, attributes = {})
      ...
      usage_limit = FactoryBot.build_stubbed(:usage_limit, attributes)
    ...
    def stub_buyer_account(plan, attributes = {})
      buyer_account = FactoryBot.build_stubbed(:buyer_account, attributes)

      cinstance = FactoryBot.build_stubbed(:cinstance, :plan => plan, :user_account => buyer_account)
