...
Given "an invoice of {buyer} for {date_month}" do |buyer, date|
  create_invoice buyer, date
end

Given "I create a new invoice from the API for this buyer for {date_month} with:" do |month, items|
...
Given "an issued invoice of {buyer} for {date_month}" do |buyer, month|
  invoice = create_invoice buyer, month
  invoice.issue_and_pay_if_free!
end

Given "an invoice of {buyer} for {date_month} with items(:)" do |buyer, month, items|
  invoice = create_invoice buyer, month
