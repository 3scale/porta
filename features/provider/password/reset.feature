...
Feature: Provider password reset
  ...
  Rule: On provider domain
    ...
    Scenario: Set a new password
      ...
      And they fill in "Password" with "Supersecret123+!"
      And they fill in "Password confirmation" with "Supersecret123+!"
      ...
      And the user is now able to sign in with password "Supersecret123+!"
    ...
    Scenario: New password form validation
      ...
      Then the submit button is disabled
      When they fill in "Password confirmation" with "Supersecret123+!"
      Then the submit button is enabled
