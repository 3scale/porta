...
Feature: Application edit page
  ...
  Scenario: Editing an application
    ...
    When the form is submitted with:
      | Name | Cool App |
    Then they should see a toast alert with text "Application was successfully updated"
  ...
  Scenario: Delete application
    ...
    Then they should see a toast alert with text "The application was successfully deleted"
