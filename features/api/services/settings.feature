Feature: Integration Settings
  ...
  Scenario: Integration Settings and authentication method interaction
    ...
    When I click on the label "APIcast self-managed" and I reject dialog box "This action deletes the corresponding routes in OpenShift and reverts the Public Base URLs back to the latest value. Do you want to continue?"
    ...
    When I click on the label "APIcast self-managed" and I confirm dialog box "This action deletes the corresponding routes in OpenShift and reverts the Public Base URLs back to the latest value. Do you want to continue?"
    ...
    When I click on the label "Istio" and I confirm dialog box "This action sets the Public Base URLs with values generated by the system and creates the corresponding routes in OpenShift. Do you want to continue?"
  ...
  Scenario: Production and Staging URL are grayed out when 3scale-managed APIcast
    ...
    When I click on the label "APIcast" and I confirm dialog box "This action sets the Public Base URLs with values generated by the system and creates the corresponding routes in OpenShift. Do you want to continue?"
