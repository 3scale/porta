@javascript
Feature: Product > Applications > New
  ...
  Scenario: Create an application
    Given they go to product "My API" new application page
  ...
  Scenario: Create an application without being subscribed to a product
    ...
    And they go to product "My API" new application page
    When the form is submitted with:
      | Account          | Jane           |
      | Application plan | Basic          |
      | Name             | New App        |
  ...
  Scenario: Create an application when product has no application plans
    ...
    And they go to product "No plans API" new application page
