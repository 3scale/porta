...
Feature: Product > Integration > Metrics > Edit
  ...
  Rule: Methods
    ...
    Scenario: Editting a method
      ...
      Then should see a toast alert with text "The method was updated"
    ...
    Scenario: Deleting a method
      ...
      Then should see a toast alert with text "The method was deleted"
  ...
  Rule: Metrics
    ...
    Scenario: Editting a metric
      ...
      Then should see a toast alert with text "The metric was updated"
      And should see the following table:
    ...
    Scenario: Deleting a metric
      ...
      When they follow "Delete"
      And confirm the dialog
      Then should see a toast alert with text "The metric was deleted"
    ...
    Scenario: Cannot delete a metric used in the latest gateway configuration
      ...
      And follow "Delete"
      And confirm the dialog
      Then should see a toast alert with text "Metric is used by the latest gateway configuration and cannot be deleted"
