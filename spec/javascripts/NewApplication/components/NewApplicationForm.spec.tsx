...
const selectBuyer = (wrapper: ReactWrapper<any>, buyer) => select(wrapper, 'BuyerSelect', buyer)
const selectProduct = (wrapper: ReactWrapper<any>, product) => select(wrapper, 'ProductSelect', product)
const selectApplicationPlan = (wrapper: ReactWrapper<any>, plan: {
  default: boolean,
  id: number,
  issuer_id: number,
  name: string
}) => select(wrapper, 'ApplicationPlanSelect', plan)
const selectServicePlan = (wrapper: ReactWrapper<any>, plan: {
  id: number,
  name: string
}) => select(wrapper, 'ServicePlanSelect', plan)

describe('when in Service context', () => {
  let props
  const servicePlan = { id: 0, name: 'Service Plan' } as const
  ...
  describe('when product has no application plans', () => {
    const productWithNoAppPlans = { ...currentProduct, appPlans: [] } as const
  ...
  describe('when product has application plans', () => {
    const productWithAppPlans = { ...currentProduct, appPlans } as const
    ...
    describe('and it has a default application plan', () => {
      ...
      const productWithDefaultAppPlan = { ...productWithAppPlans, defaultAppPlan } as const
    ...
    describe('but it has no default application plan', () => {
      const productWithNoDefaultAppPlan = { ...productWithAppPlans, defaultAppPlan: null } as const
  ...
  describe('when service plans are allowed', () => {
    ...
    describe('when the buyer is not subscribed to the current product', () => {
      ...
      describe('when the current product has service plans and one is default', () => {
        const defaultServicePlan = { id: 100, name: 'Other plan (default)' } as const
        const servicePlans = [
      ...
      describe('when the current product has service plans but none is default', () => {
        ...
        const productWithNoDefaultPlan = { ...currentProduct, servicePlans, defaultServicePlan: null } as const
...
describe('when in Account context', () => {
  ...
  describe('when selected product has no application plans defined', () => {
    const productWithNoAppPlans = { ...products[0], appPlans: [] } as const
  ...
  describe('when selected product has application plans', () => {
    const productWithAppPlans = { ...products[0], appPlans } as const
  ...
  describe('when service plans are allowed', () => {
    ...
    describe('when the current buyer is subscribed to the selected product', () => {
      ...
      const subscribedProduct = { ...products[0], id, name, servicePlans: [servicePlan] } as const
    ...
    describe('when the current buyer is not subscribed to the selected product', () => {
      ...
      describe('when it has no service plans', () => {
        const productWithNoPlans = { ...products[0], servicePlans: [] } as const
      ...
      describe('when it has service plans and one is default', () => {
        ...
        const productWithDefaultPlan = { ...products[0], servicePlans, defaultServicePlan } as const
      ...
      describe('when it has service plans but none is default', () => {
        ...
        const productWithNoDefaultPlan = { ...products[0], servicePlans, defaultServicePlan: null } as const
...
describe('when in Audience context', () => {
  ...
  describe('when selected product has application plans', () => {
    ...
    describe('and it has a default application plan', () => {
      const defaultAppPlan = appPlans[0]
      const productWithDefaultPlan = { ...productWithAppPlans, defaultAppPlan } as const
    ...
    describe('but it does not have a default application plan', () => {
      const productNoDefaultPlan = { ...productWithAppPlans, defaultAppPlan: null } as const
  ...
  describe('when service plans are allowed', () => {
    ...
    describe('when the selected buyer is subscribed to the selected product', () => {
      ...
      const contractedProduct = { ...products[0], id, name, servicePlans: [servicePlan] } as const
      const subscribedBuyer = { ...buyers[0], contractedProducts: [{ id, name: name, withPlan: servicePlan }] } as const
    ...
    describe('when the selected buyer is not subscribed to the selected product', () => {
      const buyerNotSubscribed = { ...buyers[0], contractedProducts: [] } as const
