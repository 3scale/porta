...
const policies: ChainPolicy[] = [
  ...
  { enabled: true, name: 'echo', humanName: 'Echo', description: ['Echoes the request'], version: '1.0.0', configuration: {}, $schema: '', data: {}, removable: true, summary: '', uuid: '2' }
]
...
it('should render an input with the parsed policies as value', () => {
  ...
  const value = wrapper.find('input').prop('value') as string
